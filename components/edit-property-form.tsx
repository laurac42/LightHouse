...
import { fetchPropertyDetails, removeBulletsAndHeadings, getFeaturesFromDescription, removeParagraphsAndHeadings } from "@/lib/data/property-utils";
    ...
    useEffect(() => {
        const fetchProperty = async () => {
            ...
            if (property) {
                ...
                setDescription(removeBulletsAndHeadings(property.description));
                setPrice(property.price.toString());
                setPriceType(property.price_type || "");
                setFeatures(getFeaturesFromDescription(removeParagraphsAndHeadings(property.description || "")));
                setAddress({
