...
alter table "public"."user_roles" drop constraint "user_roles_user_id_fkey";
  ...
  create table "public"."property_tag_flags" (
    "tag_id" bigint not null,
    "created_at" timestamp with time zone not null default now(),
    "property_id" bigint not null,
    "user_id" uuid not null,
    "reason" text not null default 'irrelevant'::text
      );


alter table "public"."property_tag_flags" enable row level security;

CREATE UNIQUE INDEX property_tag_flags_pkey ON public.property_tag_flags USING btree (property_id, tag_id, user_id);

alter table "public"."property_tag_flags" add constraint "property_tag_flags_pkey" PRIMARY KEY using index "property_tag_flags_pkey";
...
grant delete on table "public"."property_tag_flags" to "anon";

grant insert on table "public"."property_tag_flags" to "anon";

grant references on table "public"."property_tag_flags" to "anon";

grant select on table "public"."property_tag_flags" to "anon";

grant trigger on table "public"."property_tag_flags" to "anon";

grant truncate on table "public"."property_tag_flags" to "anon";

grant update on table "public"."property_tag_flags" to "anon";

grant delete on table "public"."property_tag_flags" to "authenticated";

grant insert on table "public"."property_tag_flags" to "authenticated";

grant references on table "public"."property_tag_flags" to "authenticated";

grant select on table "public"."property_tag_flags" to "authenticated";

grant trigger on table "public"."property_tag_flags" to "authenticated";

grant truncate on table "public"."property_tag_flags" to "authenticated";

grant update on table "public"."property_tag_flags" to "authenticated";

grant delete on table "public"."property_tag_flags" to "service_role";

grant insert on table "public"."property_tag_flags" to "service_role";

grant references on table "public"."property_tag_flags" to "service_role";

grant select on table "public"."property_tag_flags" to "service_role";

grant trigger on table "public"."property_tag_flags" to "service_role";

grant truncate on table "public"."property_tag_flags" to "service_role";

grant update on table "public"."property_tag_flags" to "service_role";
